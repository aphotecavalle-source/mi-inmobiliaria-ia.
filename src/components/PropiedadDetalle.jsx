...
const PropiedadDetalle = () => {
  // Datos finales de Casa en el Bosque
  const propiedad = {
    ...
    imagenPrincipal: "https://images.unsplash.com/photo-1449156001437-3a1661dcda2e?q=80&w=2070", // Foto de la cabaña
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ" // Reemplaza este link por el de tu video
  };
    ...
    <div className="container" style={{ marginTop: '40px' }}>
      <div className="card-propiedad" style={{ marginBottom: '50px' }}>
        ...
        <div className="video-section" style={{ marginTop: '50px', borderTop: '1px solid rgba(0,0,0,0.05)', paddingTop: '40px' }}>
          ...
          <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', borderRadius: '12px', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }}>
            <iframe 
