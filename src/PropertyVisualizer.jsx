...
const PropertyVisualizer = () => {
  ...
  // FUNCIÓN WHATSAPP CON MENSAJE INTELIGENTE
  const handleWhatsApp = () => {
    const message = encodeURIComponent(`¡Hola! Me interesa la propiedad "${propertyData.title}" en ${propertyData.location} que vi en tu visualizador inteligente. ¿Me podrías dar más información?`);
